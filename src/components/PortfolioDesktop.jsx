                ...
                <Box  minHeight='100vh' display='flex' justifyContent='center' mb={5}>
                    <Box  minHeight={500} width='85%' mt={5} >
                        ...
                        <Box display='flex' justifyContent='center'>
                            <Button color='secondary' onClick={handleOpenMenu} endIcon={<ArrowDropDownIcon sx={{color:'white'}} />} aria-controls='menu' variant='contained' sx={{height:75, width:700, mt:5}} >
                                Other Projects
                            </Button>
                            <Menu id='menu' anchorEl={anchorEl} open={open} onClose={handleCloseMenu} MenuListProps={{'aria-labelledby': 'basic-button'}}>
                                ...
                                <MenuItem onClick={handleCloseMenu} sx={{width:700}}>
                                    Pricing Page
                                </MenuItem>
                                </a>
