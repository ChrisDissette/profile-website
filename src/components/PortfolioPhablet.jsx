                ...
                <Box  minHeight='100vh' display='flex' justifyContent='center'>
                    <Box  minHeight={500} width='85%' mt={5} mb={5} >
                        ...
                        <Grid container mt={5} direction={{xs:'column', sm:'column', md:'row', lg:'row'}} >
                            ...
                            <Grid item xs={6} height={450} className={classes.gridContent}>
                                <Box className={classes.gridCopy}>
                                    ...
                                    <Button href="https://starwars-api-two.vercel.app/" target="_blank" variant='contained' color='secondary'sx={{height:57, width:190, mt:5, mb:5}}>Launch Site</Button>
                                </Box>
                            </Grid>
                            ...
                            <Grid item xs={6}  height={450} mt={5} className={classes.gridContent}>
                                <Box className={classes.gridCopy}>
                                    ...
                                    <Button href='https://fantasy-football-draft-order.vercel.app/' target='_blank' variant='contained' color='secondary'sx={{height:57, width:190, mt:5, mb:5}}>Launch Site</Button>
                                </Box>
                            </Grid>
                            ...
                            <Grid item xs={6}  height={450} mt={5} className={classes.gridContent}>
                                <Box className={classes.gridCopy}>
                                    ...
                                    <Button href='https://to-do-list-lac.vercel.app/' target='_blank' variant='contained' color='secondary'sx={{height:57, width:190, mt:5, mb:5}}>Launch Site</Button>
                                </Box>
                            </Grid>
                            ...
                            <Grid item xs={6}  height={450} mt={5} className={classes.gridContent}>
                                <Box className={classes.gridCopy}>
                                    ...
                                    <Button href='https://magic-eight-ball-ashy.vercel.app/' target='_blank' variant='contained' color='secondary'sx={{height:57, width:190, mt:5, mb:5}}>Launch Site</Button>
                                </Box>
                            </Grid>
                            ...
                            <Grid item xs={6}  height={450} mt={5} className={classes.gridContent}>
                                <Box className={classes.gridCopy}>
                                    ...
                                    <Button href='https://drink-water-ashen.vercel.app/' target='_blank' variant='contained' color='secondary'sx={{height:57, width:190, mt:5, mb:5}}>Launch Site</Button>
                                </Box>
                            </Grid>
                        ...
                        <Box display='flex' justifyContent='center'>
                            <Button color='secondary' onClick={handleOpenMenu} endIcon={<ArrowDropDownIcon sx={{color:'white'}} />} aria-controls='menu' variant='contained' sx={{height:75, width:400, mt:5}} >
                                Other Projects
                            </Button>
                            <Menu id='menu' anchorEl={anchorEl} open={open} onClose={handleCloseMenu} MenuListProps={{'aria-labelledby': 'basic-button'}}>
                                ...
                                <MenuItem onClick={handleCloseMenu} sx={{width:400}}>
                                    Pricing Page
                                </MenuItem>
                                </a>
...
export default PortfolioPhablet
